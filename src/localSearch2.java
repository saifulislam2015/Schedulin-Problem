...
public class localSearch2 {
    ...
    public  localSearch2(int P,int t,int r,int c,int k,Vector<schedule> e){
        localSearch.P = P;
        T = t;
        R = r;
        C = c;
    ...
    public static void main(String[] args) {
        ...
        int P = 6 ;
        int K = 5;
        Vector<schedule> init = new Vector<schedule>() ;
        for(int i=0;i<K;i++){
        ...
        localSearch2 beam = new localSearch2(P,T,R,C,K,init);
        schedule soln = beam.StochasticSearch();
        int res = beam.CostFunction(soln)-30;
        //schedule soln = beam.StochasticSearch();
